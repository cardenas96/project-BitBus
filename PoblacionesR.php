...
function Header()
{
    ...
    $this->Cell(0,6,'Poblaciones Registradas',0,1,'C');	
    $this->Ln(10);
...
$pdf->AddCol('idPoblacion',15,'ID','R');
$pdf->AddCol('nombre',40,"Poblaciones",'L');
//$pdf->AddCol('pop',40,'Pop (2001)','R');
$prop = array('HeaderColor'=>array(234, 234, 234),
            'color1'=>array(245, 245, 245),
            'color2'=>array(194, 194, 194),
            'padding'=>2);
$pdf->Table($link,'SELECT * FROM POBLACIONES ',$prop);
$pdf->Output();
?>